          ...
          {done ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: 14 }}>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.5)', marginBottom: 5, textTransform: 'uppercase', letterSpacing: '0.8px' }}>Role</label>
                  <select style={{ ...fieldStyle, background: 'rgba(255,255,255,0.06)', border: '1.5px solid rgba(255,255,255,0.1)', color: 'white' }} value={selectedRole} onChange={e => setSelectedRole(e.target.value)}>
